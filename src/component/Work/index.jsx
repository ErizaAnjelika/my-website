...
export const Work = () => {
  return (
    <div className="bg-[#ebebeb] px-5 md:px-12 lg:px-36 pb-10 space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {DataProjects.map((data, index) => (
          <div
            key={index}
            className="relative h-[250px] w-full rounded-md overflow-hidden group shadow-md shadow-gray-400 hover:shadow-lg hover:shadow-gray-500 transition-shadow duration-300 ease-in-out"
          >
            <img
              src={data.image}
              alt="Project"
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-orange-400 bg-opacity-90 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out">
              ...
              <div className="mt-2 py-5 space-y-8 bg-gray-400 px-3">
